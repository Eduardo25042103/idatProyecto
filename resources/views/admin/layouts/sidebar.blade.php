<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
      <div class="sidebar-brand">
        <img src="{{ asset('backend/assets/img/logo-01.png')}}" width="200px" alt="Atlantic City">
      </div>
      <div class="sidebar-brand sidebar-brand-sm">
        <img src="{{ asset('backend/assets/img/faviconV2.png')}}" width="40px" alt="Atlantic City">
      </div>
      <ul class="sidebar-menu">
        <li><a class="nav-link" href="blank.html"><i class="fa fa-server"></i> <span>Master Data</span></a></li>
        <li class="menu-header">Gestión Central</li>
        <li class="dropdown">
          <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fa fa-users"></i> <span>Usuarios</span></a>
        ...
        <li><a class="nav-link" href="blank.html"><i class="fa fa-server"></i> <span>Master Data</span></a></li>
        <li class="dropdown">
          <a href="#" class="nav-link has-dropdown"><i class="fas fa-th"></i> <span>Empleados</span></a>
          <ul class="dropdown-menu">
        ...
        <li class="menu-header">Opercional</li>
        <li class="dropdown">
          <a href="#" class="nav-link has-dropdown"><i class="fas fa-th-large"></i> <span>Campañas</span></a>
          <ul class="dropdown-menu">
